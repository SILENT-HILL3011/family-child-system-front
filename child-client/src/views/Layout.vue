...
const menuList = ref([
  {
    name: '用户管理',
    path: '/user',
    img: 'https://picsum.photos/seed/user/800/400',
    desc: '管理家庭成员信息，维护家庭档案'
  },
  {
    name: '成长档案与监测',
    path: '/growth',
    img: 'https://picsum.photos/seed/growth/800/400',
    desc: '记录孩子成长数据，监测健康发育'
  },
  {
    name: '智能日程',
    path: '/schedule',
    img: 'https://picsum.photos/seed/schedule/800/400',
    desc: '疫苗、体检等育儿日程智能提醒'
  },
  {
    name: '家庭协同与共享',
    path: '/family',
    img: 'https://picsum.photos/seed/family/800/400',
    desc: '家庭留言板，全家协同育儿'
  },
  {
    name: '实用工具',
    path: '/util',
    img: 'https://picsum.photos/seed/tool/800/400',
    desc: '知识图谱、过敏原查询等育儿工具'
  },
  {
    name: '专家咨询',
    path: '/expert',
    img: 'https://picsum.photos/seed/expert/800/400',
